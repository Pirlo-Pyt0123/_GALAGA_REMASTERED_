...
AC_Mecha_Giga::AC_Mecha_Giga()
{
    ...
    ProjectileMesh->OnComponentHit.AddDynamic(this, &AC_Mecha_Giga::OnHit);
    ...
    static ConstructorHelpers::FObjectFinder<UNiagaraSystem> NiagaraSystemAsset(TEXT("NiagaraSystem'/Game/3D_Lasers/Effects/NS_LaserHit_7.NS_LaserHit_7'"));
...
void AC_Mecha_Giga::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
    ...
    if (OtherActor && OtherActor != this && OtherComp)
    {
        ...
        if (Nave_Padre)
        {
            ...
            Nave_Padre->Damage_received(400.f); // Daño a la nave del jugador
