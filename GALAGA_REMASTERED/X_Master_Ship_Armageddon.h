...
#include "X_Master_Ship_Armageddon.generated.h"


UCLASS()
class GALAGA_REMASTERED_API AX_Master_Ship_Armageddon : public AX_Master_Ship_P
{
	GENERATED_BODY()

public:

	AX_Master_Ship_Armageddon();


	//audio component
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Audio")
	class UAudioComponent* Au_Arm;

	

	//niagara Component
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Niagara")
	class UNiagaraComponent* Nia_Arm;
