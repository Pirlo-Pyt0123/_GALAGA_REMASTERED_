...
AT_TerraBley_Cosmic_Seal::AT_TerraBley_Cosmic_Seal()
{

	PrimaryActorTick.bCanEverTick = true;

	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/Stylized_Crystals/Mesh/crystal_36_1.crystal_36_1'"));
	...
	if (ParticleAsset.Succeeded())
	{
		...
		PPt->SetWorldScale3D(FVector(10.5f, 10.5f, 0.5f));
	}
	...
	Identificador_TerraBley = "One";
}

void AT_TerraBley_Cosmic_Seal::BeginPlay()
{
	Super::BeginPlay();
}

void AT_TerraBley_Cosmic_Seal::Tick(float DeltaTime)
{
