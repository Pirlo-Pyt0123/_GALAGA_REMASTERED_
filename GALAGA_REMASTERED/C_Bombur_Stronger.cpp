...
AC_Bombur_Stronger::AC_Bombur_Stronger()
{
    ...
    ProjectileMesh->OnComponentHit.AddDynamic(this, &AC_Bombur_Stronger::OnHit);
    ...
    static ConstructorHelpers::FObjectFinder<UNiagaraSystem> NiagaraSystemAsset(TEXT("NiagaraSystem'/Game/3D_Lasers/Effects/NS_LaserFlash_5.NS_LaserFlash_5'"));
...
void AC_Bombur_Stronger::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
