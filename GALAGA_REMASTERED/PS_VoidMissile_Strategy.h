...
#include "PS_VoidMissile_Strategy.generated.h"

UCLASS()
class GALAGA_REMASTERED_API APS_VoidMissile_Strategy : public AActor, public IPS_ChangeWeapon
{
	GENERATED_BODY()
	
public:

	APS_VoidMissile_Strategy();
