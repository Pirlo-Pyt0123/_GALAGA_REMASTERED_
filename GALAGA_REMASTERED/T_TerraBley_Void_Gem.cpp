...
AT_TerraBley_Void_Gem::AT_TerraBley_Void_Gem()
{
	PrimaryActorTick.bCanEverTick = true;

	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/Stylized_Crystals/Mesh/crystal_36_2.crystal_36_2'"));
	...
	Identificador_TerraBley = "Five";
	
}

void AT_TerraBley_Void_Gem::BeginPlay()
{
	Super::BeginPlay();
}

void AT_TerraBley_Void_Gem::Tick(float DeltaTime)
{
